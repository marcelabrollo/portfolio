...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const slidesTERAPIA = {
    ...
    7: { src: "caminhada_000.jpg", caption: `Traduction de l’image :<br><strong>Pas besoin de se presser, chaque processus a son propre rythme.</strong><br><em>Avancez à votre propre cadence.</em>` },
    8: { src: "MEME.jpg", caption: `Traduction de l’image :<br><strong>Quand quelqu’un comprend enfin ce que vous vouliez dire.</strong><br><em>Merci!</em>` }
  };
